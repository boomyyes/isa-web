            ...
            >
              ...
              >
                {/* Base image with grayscale and scanlines by default.
                    ...
                    changes. The filter is md: only — phones skip the
                    grayscale pass entirely rather than paying for it. */}
                <div
                  className="absolute inset-0 bg-cover bg-center transition-[filter,transform] duration-500 md:grayscale md:group-hover:grayscale-0 md:group-hover:scale-105"
